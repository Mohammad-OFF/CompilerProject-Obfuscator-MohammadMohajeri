...
class MiniCListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by MiniCParser#breakStatement.
    def enterBreakStatement(self, ctx:MiniCParser.BreakStatementContext):
        pass

    # Exit a parse tree produced by MiniCParser#breakStatement.
    def exitBreakStatement(self, ctx:MiniCParser.BreakStatementContext):
        pass
    ...
    # Enter a parse tree produced by MiniCParser#switchStatement.
    def enterSwitchStatement(self, ctx:MiniCParser.SwitchStatementContext):
        pass

    # Exit a parse tree produced by MiniCParser#switchStatement.
    def exitSwitchStatement(self, ctx:MiniCParser.SwitchStatementContext):
        pass


    # Enter a parse tree produced by MiniCParser#caseStatement.
    def enterCaseStatement(self, ctx:MiniCParser.CaseStatementContext):
        pass

    # Exit a parse tree produced by MiniCParser#caseStatement.
    def exitCaseStatement(self, ctx:MiniCParser.CaseStatementContext):
        pass


    # Enter a parse tree produced by MiniCParser#defaultStatement.
    def enterDefaultStatement(self, ctx:MiniCParser.DefaultStatementContext):
        pass

    # Exit a parse tree produced by MiniCParser#defaultStatement.
    def exitDefaultStatement(self, ctx:MiniCParser.DefaultStatementContext):
        pass
