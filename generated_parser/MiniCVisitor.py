...
class MiniCVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by MiniCParser#blockContent.
    def visitBlockContent(self, ctx:MiniCParser.BlockContentContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MiniCParser#breakStatement.
    ...
    # Visit a parse tree produced by MiniCParser#forInitializer.
    ...
    # Visit a parse tree produced by MiniCParser#switchStatement.
    def visitSwitchStatement(self, ctx:MiniCParser.SwitchStatementContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MiniCParser#caseStatement.
    def visitCaseStatement(self, ctx:MiniCParser.CaseStatementContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MiniCParser#defaultStatement.
